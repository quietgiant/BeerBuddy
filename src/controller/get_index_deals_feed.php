<?php
    ...
    $sql = sprintf("SELECT alcohol_type, drink_name, price, size, store_name, address, city, date, username FROM deal_posts INNER JOIN user_data ON deal_posts.user_id = beerbuddy.user_data.id ORDER BY deal_posts.id desc LIMIT 3;");
